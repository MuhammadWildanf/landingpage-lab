...
export default function About() {
    return (
        <div className="w-full max-w-6xl mx-auto px-4 sm:px-0 min-h-screen flex items-center mb-24">
            <section className="flex flex-col sm:flex-row items-start justify-between gap-2 sm:gap-4" data-aos="fade-left">
                {/* Gambar Tim */}
